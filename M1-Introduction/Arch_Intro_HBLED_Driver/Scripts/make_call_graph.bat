...
@echo on
"..\..\Tools\Calls\call_graph_generator.py" -i mycallgraph.txt  -o cg.gv
REM "C:\Users\Alex\Documents\Teaching\ESA\ESA-Fall-2020\Code\Keil-uVision-Call-Graph-Generator\call_graph_generator.py" -i mycallgraph.txt  -o cg.gv
