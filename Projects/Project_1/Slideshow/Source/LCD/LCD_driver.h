...
#define USE_LARGE_FONT (0) // 1 for original 12x19 font, 0 for smaller 8x13 font
#define USE_TOUCHSCREEN (0) // 1 to enable code for reading touchscreen, 0 to disable 
