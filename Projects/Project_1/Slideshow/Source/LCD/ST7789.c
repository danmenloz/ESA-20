...
const LCD_CTLR_INIT_SEQ_T Init_Seq_ST7789[] = {
	...
	{LCD_CTRL_INIT_SEQ_CMD, 0x3A}, {LCD_CTRL_INIT_SEQ_DAT, 0x55},
	{LCD_CTRL_INIT_SEQ_CMD, 0xB2}, {LCD_CTRL_INIT_SEQ_DAT, 0x0C},
	...
	{LCD_CTRL_INIT_SEQ_CMD, 0xC2}, {LCD_CTRL_INIT_SEQ_DAT, 0x01},
	...
	{LCD_CTRL_INIT_SEQ_CMD, 0xD0}, {LCD_CTRL_INIT_SEQ_DAT, 0xA4},
			{LCD_CTRL_INIT_SEQ_DAT, 0xA1},
	{LCD_CTRL_INIT_SEQ_CMD, 0xE0}, {LCD_CTRL_INIT_SEQ_DAT, 0xD0},
	...
	{LCD_CTRL_INIT_SEQ_CMD, 0xE1}, {LCD_CTRL_INIT_SEQ_DAT, 0xD0},
			{LCD_CTRL_INIT_SEQ_DAT, 0x00}, {LCD_CTRL_INIT_SEQ_DAT, 0x05},
...
static void LCD_Init_Backlight(void) {
	...
	PWM_Init(LCD_BL_TPM, LCD_BL_TPM_CHANNEL, LCD_BL_PERIOD,
					 3 * LCD_BL_PERIOD / 4);
...
static void LCD_24S_Write_Command(uint8_t command) {
	GPIO_ResetBit(LCD_D_NC_POS);	// Default is sending data, so instead assert command
	GPIO_Write(command);
