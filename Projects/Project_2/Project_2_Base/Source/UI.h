...
#define UI_SLIDER_HEIGHT 		(15)
#define UI_SLIDER_WIDTH 		(LCD_WIDTH)
#define UI_SLIDER_BAR_WIDTH (8)

#define NUM_CURR_PIXELS    	LCD_WIDTH
#define SAMPLES_PER_PIXEL  	(NUM_CURR_SAMPLES/NUM_CURR_PIXELS)
#define PRE_TRIG_SAMPLES    0   /* start the display this many samples before start of trigger */

#define PARTIAL_SCOPE_ERASE 1
...
#define SCALE_SCOPE(val) (g_scope_height - ( g_scope_height * (val) / 0xFFFF))
#define SCALE_MEASURED(sample) ((sample)*CVT_RATIO)
